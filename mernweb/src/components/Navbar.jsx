...
<nav className ="navbar navbar-expand-lg bg-dark shadow-white">
        <div className ="container">
          <div>
        <NavLink className ="navbar-brand text-white" to="/">Iskcon</NavLink>
      ...
      <i className="fa fa-user-plus me-2"></i>Donation</NavLink>
